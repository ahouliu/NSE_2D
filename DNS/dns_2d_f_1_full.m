...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [W_data,Psi_data,p_data,Ek,Dk,Ik,w,psi] = dns_2d_f_1_full(paras,d,e0,e1,f1,f2,Tf,w,psi)
tic;
...
W_data(:,:,1) = w;
Psi_data(:,:,1) = psi;
p_data(:,:,1)   = pressure_func(psi_hat,t0,w_force,f1xf2y_hat);
...
for ind = 1:Ninteration
    ...
    if mod(ind,interval)==0
        jnd = ind/interval;
         ...
         Psi_data(:,:,1+jnd) = real(ifft2(psi_hat));
         p_data(:,:,1+jnd)   = pressure_func(psi_hat,t0+ind*dt,w_force,f1xf2y_hat);
         Ek(jnd+1)           =  E2;
