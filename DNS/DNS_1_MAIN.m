...
% end
% w   = 2*A*sin(X).*sin(Y);
% psi = A*Ly/(2*pi)*sin(X).*sin(Y); 
%************************************************************************  
%******************  TWO. from decaying spectrum  **************************
%************************************************************************  
kf      = 3;
...
t0      = 0;
t_max   = 20;
% [W_data,Ek,Dk,Ik,w,psi]                     = dns_2d_f_1(parasF,dt,t0,t_max,ep1,ep2,T_force,w0,psi0);
% [W_data,Psi_data,p_data,Ek,Dk,Ik,w,psi] = dns_2d_f_1_full(parasF,dt,t0,t_max,ep1,ep2,T_force,w0,psi0);
% [w,psi,Ek,Dk,Ik]                            = dns_2d_f_1_final(parasF,dt,t0,t_max,ep1,ep2,T_force,w0,psi0);
[w,psi,Ek]                                    = dns_2d_f_1_final0(parasF,dt,t0,t_max,ep1,ep2,T_force,w0,psi0);
%% plotting 
close all;
